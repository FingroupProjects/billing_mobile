...
class _ClientAddScreenState extends State<ClientAddScreen> {
                          ...
                          CustomPhoneNumberInput(
                            ...
                            onInputChanged: (String number) {
                              setState(() {
                                ...
                                final code = number.replaceFirst('+', '');
                                context.read<TariffBloc>().add(LoadTariffEvent(code));
                              });
                            },
                            validator: (value) {
                              if (value == null || value.isEmpty) {
  ...
  void _createLead() {
    ...
    final String? contactPerson =
        contactPersonLoginController.text.isEmpty ? null : contactPersonLoginController.text;
