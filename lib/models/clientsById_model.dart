  ...
  final String? managerName; // Новое поле для имени менеджера
  ...
  ClientById({
    ...
    this.countryName,
    this.partnerName,
    this.managerName, // Добавляем в конструктор
    this.history,
  });
  ...
  factory ClientById.fromJson(Map<String, dynamic> json) {
    ...
    print('Parsing managerName: ${json['manager']}');
    final managerName = json['manager'] != null ? json['manager']['name'] as String? : null;
    print('managerName parsed: $managerName');
    ...
    return ClientById(
      ...
      managerName: managerName, // Добавляем в конструктор
      history: history,
    );
  }
}
